...
slangS = pd.read_csv('https://raw.githubusercontent.com/RifaldiAchmad/BERT/refs/heads/main/slang.csv', header=None, index_col=0).squeeze().to_dict()
...
stopCustom = set([s.lower().strip() for s in loadText('https://raw.githubusercontent.com/RifaldiAchmad/BERT/refs/heads/main/stopwords_id.txt')])
